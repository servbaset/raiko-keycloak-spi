...
public class UserDao {
    ...
    public User getUserByUsername(String username) {
        ...
        try (var connection = DatabaseConfiguration.getConnection(config)) {
            ...
            try (var findAdminStatement = connection.prepareStatement(userQuery, ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE)) {
                ...
                if (existUser)
                    user = getUserObject(findUserResult);
            }
